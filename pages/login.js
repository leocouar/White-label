          ...
          <div className="">
            ...
            <div className="">
              <button
                ...
                style={{ height: '52px' }}
                className="relative w-32 py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-800 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 "
              >
              ...
              <h1 className="text-center ml-5 text-xs">Iniciar sesión con Google</h1>
            </button>
              <button
                type="button"
                ...
                style={{ 
              height: '52px' }}
                className="relative ml-1 w-32 py-1 px-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                <span className="absolute left-1 inset-y-0 flex items-center pl-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                ...
                <h1 className="text-center ml-5 text-xs">Iniciar sesión con Facebook</h1>
              </button>
            </div>
            <p className="mt-2 text-center text-sm text-palette-primary">
            &oacute;
            &nbsp;
            <a href="/users/create" className="font-medium text-palette-primary hover:text-palette-sdark">
              Registrese
            </a>
          </p>
        </form>
