          ...
          <div className="lg:mx-6 bg-white  min-h-screen w-full">
            ...
            >
              ...
              <div className="flex w-full">
                ...
                <div className=" py-8 px-5 md:px-20 bg-white m-auto w-full md:w-1/2">
                  ...
                  <div>
                    ...
                    <div className="flex grid grid-cols-3 gap-4 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight">
                      <label className="flex flex-col items-center">
                        <img src={creditCardIcon.src} alt="Credit Card Icon" className="w-6 h-6 mb-2" />
                        <div className="mx-4 text-sm">TARJETA CREDITO/DEBITO</div>
                        <input type="radio" name="priority" onChange={() => handleSelect("credit card")} value="credit card" className="mt-2" />

                      </label>
                      <label className="flex flex-col items-center">
                        <img src={pointCard.src} alt="Credit Card Icon" className="w-6 h-6 mb-2" />
                        <div className="mx-4 text-sm">TARJETA PUNTOS</div>
                        <input type="radio" name="priority" onChange={() => handleSelect("point card")} value="point card" className="mt-2" />


                      </label>
                      <label className="flex flex-col items-center">
                        <img src={mercadoPago.src} alt="Credit Card Icon" className="w-6 h-6 mb-2" />

                        <div className="mx-4 text-sm">MERCADO PAGO</div>
                        <input type="radio" name="priority" onChange={() => handleSelect("mercado-pago")} value="mercado-pago" className="mt-2" />

                      </label>
                      <label className="flex flex-col items-center">
                        <img src={cash.src} alt="Credit Card Icon" className="w-6 h-6 mb-2" />
                        <div className="mx-4 text-sm">PAGO EN EFECTIVO</div>
                        <input type="radio" name="priority" onChange={() => handleSelect("cash")} value="cash" className="mt-2" />

                      </label>
                    </div>
                    <p>Método seleccionado: {selectedMethod}</p>
                  </div>
                    ...
                    <div>
                      ...
                      <div className="flex grid grid-cols-3 gap-4 appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight">
                        <label className="flex flex-col items-center">
                          ...
                          <div className="mx-4 text-sm">A</div>
                          <input type="radio" name="priority" onChange={() => buy("A")} value="credit card" className="mt-2" />
                        </label>
                        <label className="flex flex-col items-center">
                          <div className="mx-4 text-sm">B</div>
                          <input type="radio" name="priority" onChange={() => buy("B")} value="point card" className="mt-2" />
                        </label>
                        <label className="flex flex-col items-center">


                          <div className="mx-4 text-sm">CONSUMIDOR FINAL</div>
                          <input type="radio" name="priority" onChange={() => buy("C")} value="mercado-pago" className="mt-2" />
