          ...
          <div className="lg:mx-6 bg-white flex min-h-screen">
            <div className="bg-gray-100 w-1/5 h-auto ">
                <ul id="tabs" className="w-full sticky top-24">
                    ...
                    <li  className={`font-semibold hover:bg-red-200 py-3 flex justify-center${tabs.usuarios ? `bg-red-300` : ``}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <li className={`hover:bg-red-200 py-3 font-semibold flex justify-center${tabs.segurity ? `bg-red-300 py-3` : ``}`}>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 ml-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
