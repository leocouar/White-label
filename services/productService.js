...
export async function getPreference(cart, username) {
...
export async function searchList(page = 0, name = "", categories = "", brands = "", orderBy = "", asc = false, size = 12){
...
export async function fineProductsInStore(id) {
